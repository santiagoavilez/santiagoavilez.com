...
<div class="flex justify-center my-10 ">
<Image class="rounded-3xl" src={"/laborar/login.jpg"} format='webp' alt={'login page'} aspectRatio={495/844} width={300}   />
</div>
...
<div class="flex justify-center my-10 ">
<Image class="rounded-3xl" src="/laborar/home500w.jpg" format='webp' alt={'login page'} aspectRatio={512/631} width={512}   />
</div>
