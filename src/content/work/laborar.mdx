...
<div class="flex justify-center my-10 object-contain max-w-[272px] m-auto sm:max-w-none ">
  <video class="my-10 w-full" src="/videos/reviewapp.mp4" type="video/webm" preload="metadata" loading="lazy"	decoding="async" poster="/assets/cover_laborar.jpg" controls >
  </video >
</div>
