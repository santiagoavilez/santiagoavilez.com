...
img: /src/assets/uncoactiva/uncoactiva.jpg
img_w: 504
img_h: 360
...
<Image class="rounded-3xl" src={uncoactivaPpaginaInscrip} alt="login page." width={375}  />
</div>

<div class="flex  justify-center my-10">
<Image class="rounded-3xl" src={uncoactivaModales} alt="login page." width={375}  />
</div>
