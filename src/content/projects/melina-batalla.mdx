...
description: |
  Online course platform for a digital creator with an audience in Latin America. Built with Astro and React, integrated Mercado Pago and Lemon Squeezy for dual-market payments, and pulled course content from DailyMotion via a SQL-backed enrollment system.
tags:
  - Desarrollo web
  - Diseño web
  - Branding
