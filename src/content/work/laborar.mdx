...
description: |
  Plataforma web de trabajo freelance para profesionales y empleados domésticos, con un sistema de reseñas y un chat en tiempo real que facilita la comunicacion.
tags:
  - Desarrollo web
  - Diseño web
  - Branding
